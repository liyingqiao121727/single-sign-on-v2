...
import org.jasig.cas.util.PageUtil;
...
public final class InitialFlowSetupAction extends AbstractAction {
	...
	protected Event doExecute(final RequestContext context) throws Exception {
		...
		String warnCookieValue = this.warnCookieGenerator.retrieveCookieValue(request);

		context.getFlowScope().put("ticketGrantingTicketId", ticketGrantingTicketId);
		context.getFlowScope().put("warnCookieValue", Boolean.valueOf(warnCookieValue));
		...
		context.getFlowScope().put(PageUtil.SUB_PATH, request.getParameter(PageUtil.SUB_PATH));
		context.getFlowScope().put("mode", request.getParameter("mode"));
