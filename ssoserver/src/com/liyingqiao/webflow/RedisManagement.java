...
public class RedisManagement {
	...
	public static Object strDeserialObj(String value) throws IOException, ClassNotFoundException {
		try (ByteArrayInputStream in = new ByteArrayInputStream(Base64.getDecoder().decode(value));
				ObjectInputStream oin = new ObjectInputStream(in)) {
			return (FlowExecutionSnapshot) oin.readObject();
		}
	}
