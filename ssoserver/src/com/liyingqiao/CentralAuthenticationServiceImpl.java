...
public final class CentralAuthenticationServiceImpl implements CentralAuthenticationService {
    ...
    public List<LogoutRequest> destroyTicketGrantingTicket(final String ticketGrantingTicketId) {
        Assert.notNull(ticketGrantingTicketId, "[Assertion failed] - this argument is required; it must not be null");
    ...
    public Assertion validateServiceTicket(final String serviceTicketId, final Service service) throws TicketException {
        ...
        try {
            ...
            Document d = Document.parse(principalId);
            
            //ObjectId o = d.getObjectId("_id");
        	...
        	userRoleDoc.put("user_id", d.getObjectId("_id"));
            ...
            basicDBObject.put("$match", new BasicDBObject("role_id", new BasicDBObject("$in", list)));
    		...
    		principal.getAttributes().put(d.getString("username"), target.toString());
